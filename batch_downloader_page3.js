...
async function startBatch() {
    ...
    console.log(`📍 Iniciando Batch Scraper 2026 - PÁGINA 3. Chrome: ${chromePath}`);
    
    // 1. Obtener lista de películas de la Página 3
    console.log("🔍 Escaneando página 3 de cuevana.you...");
    let pageHtml;
    try {
        pageHtml = await fetchHtml('https://cuevana.you/peliculas?page=3');
    } catch (e) {
        console.error("Error al descargar página 3:", e.message);
        process.exit(1);
    }
    ...
    console.log(`📋 Se encontraron ${candidates.length} películas en la Página 3.`);
            ...
            if (streams && streams.length > 0) {
                ...
                if (downloaded) {
                    ...
                    try {
                        ...
                        // g. Registrar en Supabase con fecha de creación antigua (1 de mayo 2026)
                        // para que queden abajo en la lista (incluso debajo de la página 2).
    ...
    console.log(`\n🎉 Lote de página 3 completado. Total de películas descargadas en este lote: ${downloadedCount}`);
}
