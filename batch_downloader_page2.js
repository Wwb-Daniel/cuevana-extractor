...
async function startBatch() {
    ...
    console.log(`📍 Iniciando Batch Scraper 2026 - PÁGINA 2. Chrome: ${chromePath}`);
    
    // 1. Obtener lista de películas de 2026 en la Página 2
    console.log("🔍 Escaneando página 2 de cuevana.you...");
    let pageHtml;
    try {
        pageHtml = await fetchHtml('https://cuevana.you/peliculas?ano=2026&page=2');
    } catch (e) {
        console.error("Error al descargar página 2:", e.message);
        process.exit(1);
    }
    
    // Regex robusto para capturar href y el título en la tarjeta
    ...
    console.log(`📋 Se encontraron ${candidates.length} películas del año 2026 en la Página 2.`);
            ...
            if (streams && streams.length > 0) {
                ...
                if (downloaded) {
                    ...
                    try {
                        ...
                        // g. Registrar en Supabase con fecha de creación antigua (1 de junio 2026)
                        // para que queden abajo en la lista y las nuevas aparezcan arriba.
    ...
    console.log(`\n🎉 Lote de página 2 completado. Total de películas descargadas en este lote: ${downloadedCount}`);
}
