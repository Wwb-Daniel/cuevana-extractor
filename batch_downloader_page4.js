...
async function startBatch() {
    ...
    console.log("🔍 Escaneando página 4 de cuevana3i.sbs...");
    let pageHtml;
    try {
        pageHtml = await fetchHtml('https://cuevana3i.sbs/peliculas?page=4');
    } catch (e) {
            ...
            if (streams && streams.length > 0) {
                ...
                if (downloaded) {
                    ...
                    try {
                        ...
                        // g. Registrar en Supabase con fecha de creación antigua (1 de abril 2026)
                        // para que queden abajo en la lista (debajo de la página 3).
    ...
    console.log(`\n🎉 Lote de página 4 completado. Total de películas descargadas en este lote: ${downloadedCount}`);
}
